...
(function(){
  ...
  function showCalendarData() {
    var _year = dateObj.getDate().getFullYear();  //为啥不能直接调用current
    var _month = dateObj.getDate().getMonth() + 1;
    var _dateStr = getDateStr(dateObj.getDate());  //里面可以换成new Date()
    ...
    for(var i = 0; i < _tds.length; i++) {
      var _thisDay = new Date(_year, _month - 1, i + 1 - _firstDay.getDay());//星期几
